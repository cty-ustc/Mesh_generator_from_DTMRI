...
#функция чтения .ele файла
    with open('surface006.1.ele') as my_file:
...
def read_node_file():
    ...
    with open('surface006.1.node') as my_file:
...
def coord_centre_of_thetraedra(*param):
    ...
    #print 'numerator_array_x=', numerator_array_x
    #print 'numerator_array_y=', numerator_array_y
    #print 'numerator_array_z=', numerator_array_z
    #print 'denominator_array=', denominator_array
...
def write_axi(N, array_vectors):
    ...
    with open('surface006.axi', 'w') as out_mesh:
